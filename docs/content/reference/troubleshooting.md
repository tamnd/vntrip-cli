...
Most of these come down to network reality or how vntrip serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

vntrip rate-limits like any public site. vntrip already paces
...
Where a surface is gated, vntrip reads a cookie or token you supply
...
`vntrip`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what vntrip actually did
